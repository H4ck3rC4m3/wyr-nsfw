...
export class GameComponent {
  ...
  postures: string[] = ["MISSIONARY", "DOGGY", "COWGIRL", "REVERSE_COWGIRL", "69", "STANDING", "ANAL", "ORAL", "BDSM", "GOLDEN_SHOWER", "SPIDER", "TITJOB", "PEARL_NECKLACE", "CREAMPIE"];
  llocs: string[] = ["CEMETERY", "MALL", "CLASSROOM", "BEACH", "YOUR_BEDROOM", "CAR", "HOTEL_HALL", "HOLY_SEE", "FOREST", "POOL", "TRENCH", "GAZA", "GYM", "HOSPITAL"];
  condicions: string[] = ["VIOLINIST", "CLOWN", "SWEATED", "JACKET", "RABBI", "POLICE", "FOOT_ODOR", "HIGH_AF", "MUEZZIN", "SCOOBY", "SALAD", "SMOKERS", "OILED", "DIARRHEA", "TIKTOK"];
